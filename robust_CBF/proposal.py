...
#             x_0, y_0, vx_0, vy_0 = solver_mpc(x_0, y_0, vx_0, vy_0)
#             if x_0 ** 2 + y_0 ** 2 < 0.01:
#                 return [1, vx_init, vy_init]
#         except RuntimeError:
#             return [0, vx_init, vy_init]
#     return [0, vx_init, vy_init]

# VX = np.arange(-5, 5, 0.1)
# VY = np.arange(-5, 5, 0.1)
# LOG_vel = []
# ii = 0
# for vx in VX:
#     for vy in VY:
#         print("epsidoe", ii)
#         LOG_vel.append(MPC_diff_init(-3, 1, vx, vy))
#         ii += 1

# print(LOG_vel)
# import pickle

# with open('LOG_vel_2.pkl', 'wb') as f:

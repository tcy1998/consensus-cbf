...
plt.plot(plot_time(MPPI_50), state_cost(MPPI_50),label='50_samples')
plt.plot(plot_time(CBF_500), state_cost(CBF_500),label='500_samples')
plt.plot(plot_time(CBF_200), state_cost(CBF_200),label='200_samples')
plt.plot(plot_time(CBF_100), state_cost(CBF_100),label='100_samples')
plt.plot(plot_time(CBF_50), state_cost(CBF_50),label='50_samples')
plt.show()